...
DataEntry.create! ([
  ...
  {worker_id: WorkerBee.first.id, date: Date.parse("Aug 5 2020"), nectar: 300, pollen_globs: 15.5},
  ...
  {worker_id: WorkerBee.first.id, date: Date.parse("Aug 10 2020"), nectar: 440, pollen_globs: 15.1},
  {worker_id: WorkerBee.first.id, date: Date.parse("Aug 11 2020"), nectar: 450, pollen_globs: 16.3},
  {worker_id: WorkerBee.first.id, date: Date.parse("Aug 14 2020"), nectar: 450, pollen_globs: 14.8},
  ...
  {worker_id: WorkerBee.third.id, date: Date.parse("Aug 4 2020"), nectar: 300, pollen_globs: 13.8, advisement: 600},
  {worker_id: WorkerBee.third.id, date: Date.parse("Aug 6 2020"), nectar: 100, pollen_globs: 10.1},
  ...
  {worker_id: WorkerBee.fourth.id, date: Date.parse("Aug 3 2020"), nectar: 200, pollen_globs: 11.1, advisement: 300},
  ...
  {worker_id: WorkerBee.fourth.id, date: Date.parse("Aug 10 2020"), nectar: 450, pollen_globs: 10.4, advisement: 450},
  {worker_id: WorkerBee.fourth.id, date: Date.parse("Aug 11 2020"), nectar: 400, pollen_globs: 12.3},
  {worker_id: WorkerBee.fourth.id, date: Date.parse("Aug 12 2020"), nectar: 450, pollen_globs: 12.1},

  {worker_id: WorkerBee.fifth.id, date: Date.parse("Aug 4 2020"), nectar: 0, pollen_globs: 100, advisement: 100},
  {worker_id: WorkerBee.fifth.id, date: Date.parse("Aug 5 2020"), nectar: 0, pollen_globs: 130},
  ...
  {worker_id: WorkerBee.fifth.id, date: Date.parse("Aug 8 2020"), nectar: 1, pollen_globs: 305, advisement: 50},
  {worker_id: WorkerBee.fifth.id, date: Date.parse("Aug 9 2020"), nectar: 0, pollen_globs: 153, advisement: 0},
